...
public class GetUserAvatarProfileTask extends AsyncTask<Void, Void, Boolean> {


    private static final String TAG = "GetUserAvatarTask";

    private final Context context;
    private ConnectivityManager connectivityManager;
    private ContactsPresenter contactsPresenter;
    private UpdateLoginPresenter updateLoginPresenter;
    private Bitmap avatar;


    public GetUserAvatarProfileTask(Context context, UpdateLoginPresenter updateLoginPresenter) {
                    ...
                    try {
                        ...
                        if (status == 200) {
                            if (requestResult.contains("response")) {
                                ...
                                Log.e(TAG, "doInBackground: " + avatar);
                                if (avatar != null) {
                                    isSuccessful = true;
                                }
                            }
